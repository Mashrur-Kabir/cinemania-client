      ...
      {open && media && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6 pointer-events-auto">
          ...
          <motion.div
            ...
            className={cn(
              "relative w-full max-w-md bg-surface-strong glass-panel overflow-hidden flex flex-col transition-colors duration-500",
              isPending
          ...
          >
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isPending ? "text-rose-200" : "text-muted-foreground",
                  )}
                >
            ...
            <div className="p-6 border-t border-border/50  bg-surface flex items-center gap-4 relative z-10">
              <Button
                ...
                className="flex-1 bg-white/5 hover:bg-white/10 text-muted-foreground hover:text-white border border-transparent transition-colors disabled:opacity-50"
              >
                Cancel
              </Button>
              <Button
