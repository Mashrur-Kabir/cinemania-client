...
import { Badge } from "@/components/ui/badge"; // 🎯 NOW USED
import { createReviewAction } from "@/app/_actions/review.action";
import StarRating from "./StarRating";

export default function QuickReviewModal({ media }: { media: IMedia }) {
  const [open, setOpen] = useState(false);
  const [tagInput, setTagInput] = useState(""); // 🎯 NOW USED
