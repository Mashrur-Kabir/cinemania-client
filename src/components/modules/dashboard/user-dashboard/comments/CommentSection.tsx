  ...
  return (
    <section className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300">
      <div className="flex items-center gap-4">
        <div className="size-10 rounded-2xl bg-surface/[0.05] border border-border/20 flex items-center justify-center shadow-inner">
      ...
      {/* 🎯 Primary Input */}
      <div className="glass-panel p-1 rounded-[2rem] border-border/50 bg-foreground/[0.01]">
