      ...
      <div className="relative aspect-[2/3] w-full overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] transition-all duration-500 group-hover:border-primary/40 group-hover:shadow-[0_0_40px_-10px_rgba(225,29,72,0.4)]">
        ...
        {media.streamingUrl && (
          <button
            ...
            className="absolute inset-0 z-20 flex items-center justify-center opacity-0 backdrop-blur-[2px] transition-all duration-300 group-hover:opacity-100"
          >
        ...
        <div className="absolute top-3.5 inset-x-3.5 z-30 flex items-center justify-between pointer-events-none">
          ...
          <Badge
            className={cn(
              "h-6 bg-black/60 backdrop-blur-md border-white/10 text-[9px] font-black uppercase tracking-widest px-2",
          ...
          {/* 2. Right: Rating Badge (Mimicking the Badge style for perfect symmetry) */}
