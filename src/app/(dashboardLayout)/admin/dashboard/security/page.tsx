    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="relative group overflow-hidden rounded-[2rem] bg-surface border border-border/50 transition-colors duration-700 hover:border-emerald-500/20">
        ...
        <div className="lg:col-span-8">
          <div className="relative group rounded-[2.5rem] bg-surface border border-border/50 overflow-hidden transition-all duration-700 hover:border-border hover:shadow-[0_0_40px_-15px_rgba(16,185,129,0.15)]">
            ...
            <div className="relative z-10 p-8 md:p-12">
              <div className="flex items-center gap-3 mb-8">
                ...
                <div className="p-2.5 bg-foreground/[0.02] border border-border/50 rounded-lg group-hover:bg-emerald-500/10 group-hover:border-emerald-500/30 transition-colors duration-500">
                  <Lock className="size-4 text-muted-foreground group-hover:text-emerald-400 transition-colors duration-500" />
                </div>
