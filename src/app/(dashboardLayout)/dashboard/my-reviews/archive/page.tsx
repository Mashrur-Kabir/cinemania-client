...
import ArchivedReviewsTimeline from "@/components/modules/dashboard/user-dashboard/review/ArchivedReviewsTimeline";
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 animate-in fade-in slide-in-from-bottom-4 duration-700 px-6">
      ...
      >
        ...
        >
          <ArchivedReviewsTimeline page={currentPage} />
        </Suspense>
      </HomeSection>
    </div>
  );
